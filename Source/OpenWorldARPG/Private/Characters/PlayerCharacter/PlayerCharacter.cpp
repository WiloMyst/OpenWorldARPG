...
void APlayerCharacter::InitializeCharacter(const FCharacterSaveData& InSaveData, UCharacterVisualDataAsset* InVisualData, UCharacterCombatDataAsset* InCombatData, const FCharacterRegistryRow& InRegistryRow)
{
	...
	if (UPlayerCharacterMovementComponent* CustomMC = Cast<UPlayerCharacterMovementComponent>(GetCharacterMovement()))
	{
...
void APlayerCharacter::HandleMovementInput(float InputX, float InputY)
{
	...
	if (UPlayerCharacterMovementComponent* CustomMoveComp = Cast<UPlayerCharacterMovementComponent>(GetCharacterMovement()))
	{
...
{
    UPlayerCharacterMovementComponent* CustomMoveComp = Cast<UPlayerCharacterMovementComponent>(GetCharacterMovement());
...
UPlayerCharacterMovementComponent* APlayerCharacter::GetCustomMovementComponent_Implementation() const
{
