...
void UPlayerCharacterMovementComponent::OnMovementModeChanged(EMovementMode PreviousMovementMode, uint8 PreviousCustomMode)
{
    ...
    // 调用基类：恢复默认重力、Super调用、基础Tag管理、基础物理参数、委托广播
...
void UPlayerCharacterMovementComponent::TryClimb()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::EnterClimb(const FHitResult& WallHit)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::ExitClimb()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::TryClimbUp()
{
    if (!CachedOwnerCharacter.Get() || !IsClimbing()) return;
    CheckAndClimbUp();
}

void UPlayerCharacterMovementComponent::FinishClimbUp()
{
...
void UPlayerCharacterMovementComponent::DoWallEject()
{
...
bool UPlayerCharacterMovementComponent::DetectClimbableWall(FHitResult& OutChestHit)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
...
FTransform UPlayerCharacterMovementComponent::CalculateClimbWarpTarget(const FHitResult& WallHit) const
{
    ACharacter* Char = CachedOwnerCharacter.Get();
...
bool UPlayerCharacterMovementComponent::IsInCornerTransition() const
{
...
void UPlayerCharacterMovementComponent::CheckFallingToClimb()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
...
void UPlayerCharacterMovementComponent::CheckGroundedToClimb()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char || !Char->IsLocallyControlled()) return;
...
void UPlayerCharacterMovementComponent::CheckClimbToGround()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::CheckCornerTransition()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
...
void UPlayerCharacterMovementComponent::CheckAndClimbUp()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
...
void UPlayerCharacterMovementComponent::DoClimbUp()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::HandleConvexCorner(const FHitResult& NewWallHit)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::HandleConcaveCorner(const FHitResult& NewWallHit)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::PhysClimbingCornerTransition(float DeltaTime, int32 Iterations)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::PhysClimbUp(float DeltaTime, int32 Iterations)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
bool UPlayerCharacterMovementComponent::PerformClimbTraces(const FVector& TraceOffset, FHitResult& OutChestHit, FHitResult& OutHeadHit)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return false;
...
bool UPlayerCharacterMovementComponent::IsWallClimbable(const FVector& WallNormal) const
{
    return FMath::Abs(WallNormal.Z) < WallNormalZThreshold;
}

FVector UPlayerCharacterMovementComponent::CalculateConvexTargetLocation(
...
FVector UPlayerCharacterMovementComponent::CalculateConcaveTargetLocation(
...
void UPlayerCharacterMovementComponent::ClearClimbState()
{
...
void UPlayerCharacterMovementComponent::SetClimbSnapTarget(const FVector& InTargetLocation, const FRotator& InTargetRotation, float InSnapTime)
{
...
void UPlayerCharacterMovementComponent::EnterGlideMode()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::ExitGlideMode()
{
    SetMovementMode(MOVE_Falling);
}

float UPlayerCharacterMovementComponent::GetDistanceToGround() const
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::EnterSwimMode()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::ExitSwimMode()
{
    SetMovementMode(MOVE_Falling);
}

void UPlayerCharacterMovementComponent::EnterFastSwimMode()
{
...
void UPlayerCharacterMovementComponent::ExitFastSwimMode()
{
    if (!bIsFastSwimming) return;
    bIsFastSwimming = false;
    MaxFlySpeed = SwimMaxSpeed;
...
void UPlayerCharacterMovementComponent::PhysSwimming(float DeltaTime, int32 Iterations)
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::ApplySurfaceSnapping(float DeltaTime)
{
    // 预留：Water Plugin 集成后实现水面吸附
}

bool UPlayerCharacterMovementComponent::IsStillInWater() const
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return false;
...
void UPlayerCharacterMovementComponent::UpdateLastSafeLocation()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char) return;
...
void UPlayerCharacterMovementComponent::EnterSprintMode()
{
...
void UPlayerCharacterMovementComponent::ExitSprintMode()
{
...
void UPlayerCharacterMovementComponent::EnterWalkMode()
{
...
void UPlayerCharacterMovementComponent::ExitWalkMode()
{
...
void UPlayerCharacterMovementComponent::EnterAimMode()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::ExitAimMode()
{
    ACharacter* Char = CachedOwnerCharacter.Get();
    if (!Char)
    {
...
void UPlayerCharacterMovementComponent::SetFallingRotationInterpSpeed(float InSpeed)
{
