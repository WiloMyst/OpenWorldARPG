...
#include "PlayerUIExtensionComponent.generated.h"
...
/** 玩家 UI 扩展组件 (MVVM ViewModel 层)，Gameplay 与 UI 之间的唯一桥梁。 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class OPENWORLDARPG_API UPlayerUIExtensionComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UPlayerUIExtensionComponent();
