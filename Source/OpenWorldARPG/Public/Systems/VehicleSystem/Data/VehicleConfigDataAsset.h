...
#include "VehicleConfigDataAsset.generated.h"
...
class OPENWORLDARPG_API UVehicleConfigDataAsset : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    FVector ExitOffset = FVector(-200.0f, 150.0f, 0.0f);

    /** 下车安全检测半径 (cm) */
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Possession",
        meta = (DisplayName = "下车安全检测半径(cm)", ClampMin = "0.0"))
    float ExitCheckRadius = 50.0f;
