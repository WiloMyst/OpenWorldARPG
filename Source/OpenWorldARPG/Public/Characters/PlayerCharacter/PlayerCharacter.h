...
public:
	...
	virtual UPlayerCharacterMovementComponent* GetCustomMovementComponent_Implementation() const override;
	virtual UPlayerUIExtensionComponent* GetPlayerUIExtensionComponent_Implementation() const override { return PlayerUIExtensionComp; }
